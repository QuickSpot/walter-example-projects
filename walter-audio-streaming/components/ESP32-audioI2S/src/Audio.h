...
// CORE_DEBUG_LEVEL is injected by the Arduino IDE build system; fall back to
// the IDF log level when building as an IDF component.
#ifndef CORE_DEBUG_LEVEL
    #define CORE_DEBUG_LEVEL CONFIG_LOG_DEFAULT_LEVEL
#endif
